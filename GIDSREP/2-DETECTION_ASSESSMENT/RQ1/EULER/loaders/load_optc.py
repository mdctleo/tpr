...
DATE_OF_EVIL_LANL = 573290#150885
FILE_DELTA = 10000

# optc dataset
LANL_FOLDER = ''
assert LANL_FOLDER, 'Please fill in the LANL_FOLDER variable:\n line 17 /lanl_experiments/loaders/load_optc.py'
...
TIMES = {
    ...
    'all'  : 745983#1270000#5011199  # Full
}
...
def load_partial_lanl(start=140000, end=156659, delta=8640, is_test=False, ew_fn=standardized):
    ...
    fmt_line = lambda x : (int(x[0]), int(x[1]), int(x[2]), int(x[8][:-1]))
