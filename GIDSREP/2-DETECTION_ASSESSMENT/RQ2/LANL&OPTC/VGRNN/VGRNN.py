...
import loaders.load_optc as lo 
import loaders.load_lanl as ll 
...
if __name__ == '__main__':
    ...
    if 'O' in arg.dataset:
        ...
        TR_START=0
        TR_END=ll.DATE_OF_EVIL_LANL-max((ll.DATE_OF_EVIL_LANL - TR_START) // 20, DELTA*2)
        VAL_START=TR_END
        VAL_END=ll.DATE_OF_EVIL_LANL
        TE_START=ll.DATE_OF_EVIL_LANL
        TE_END = ll.TIMES['all']
        LOADER = ll.load_lanl_dist
    OUT_F = 'result_RQ2.txt'
