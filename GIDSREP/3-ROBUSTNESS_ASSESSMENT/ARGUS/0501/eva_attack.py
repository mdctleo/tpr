...
MODEL_PATH='model_save_0501_ARGUS.pkl'
CUTOFF = 0.9783
DEVICE = 'cpu' #'cuda'
...
def main():
    ...
    enc = Argus_OPTC(32, 32, device=DEVICE).to(DEVICE)
    gcn_state = {}
    ...
    for tgt_t,tgt_u,tgt_v in all_mals:
        ...
        all_extra_edges = evasion_attack(enc, rnn, rnn_h0, data_t, 0, tgt_u, tgt_v, CUTOFF, K=max(ALL_KS), N_choice=5000)
