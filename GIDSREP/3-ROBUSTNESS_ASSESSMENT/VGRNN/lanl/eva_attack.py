...
MODEL_PATH='VGRNN_lanl.pkl'

CUTOFF = 0.541921854019165
# CUTOFF = 0.90489093542099
DEVICE = 'cpu'#'cuda'
...
def main():
    ...
    TR_START=0
    TE_END =  1270000
    data = ld.load_lanl_dist (8, start=TR___, end=TE_END, delta=DELTA, is_test=True)
    model = VGRNN(15611, 32, 16, pred=False)
    print(states['states'])
