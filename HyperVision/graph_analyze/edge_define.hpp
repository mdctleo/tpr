...
private:
    ...
    vector<double> kde_density_vec;  // KDE density feature vector (optional)
...
public:
    ...
    inline void set_kde_density(const vector<double> & kde_vec) {
        kde_density_vec = kde_vec;
    }

    inline const vector<double> & get_kde_density() const {
        return kde_density_vec;
    }

    inline bool has_kde_density() const {
        return !kde_density_vec.empty();
    }
